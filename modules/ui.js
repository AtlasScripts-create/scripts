(function() {
    ...
    menu.innerHTML = `
        <div style="font-weight:bold; border-bottom:1px solid #333; margin-bottom:8px; color:#008489">VOID ATLAS v5.2</div>
        <div id="va-status">STATUS: STANDBY</div>
        <div style="margin-top:8px; font-size:10px; color:#666">F2: MOSTRAR/OCULTAR  
F4: ATIVAR/DESATIVAR</div>
    `;
